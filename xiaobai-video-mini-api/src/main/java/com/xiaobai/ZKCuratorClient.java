...
import com.xiaobai.config.ResourceConfig;
import com.xiaobai.enums.BGMOperatorTypeEnum;
...
//	public static final String ZOOKEEPER_SERVER = "192.168.1.210:2181";
	...
	public void init() {
		...
		client = CuratorFrameworkFactory.builder().connectString(resourceConfig.getZookeeperServer())
				.sessionTimeoutMs(40000).retryPolicy(retryPolicy).namespace("admin").build();
		// 启动客户端
		client.start();
